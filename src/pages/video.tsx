...
export default function Video({ videos }: InferGetStaticPropsType<typeof getStaticProps>) {
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen">
      <h1 className="text-4xl font-bold">即將上線，敬請期待~</h1>
    </div>
    /*<>
      <PageSEO title={`视频 - ${siteMetadata.author}`} description="我的YT影片" />
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          <h1 className="text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
            我的影片
          </h1>
          <p className="text-lg leading-7 text-gray-500 dark:text-gray-400">我的YT影片</p>
        </div>
