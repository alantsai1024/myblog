...
const ContentSecurityPolicy = `
  ...
  img-src * blob: data: https://img.overclockers.co.uk;
  media-src 'self';
  connect-src *;
  font-src 'self';
  frame-src giscus.app game.runjs.cool player.bilibili.com;
  manifest-src 'self' https://img.overclockers.co.uk;
`
...
module.exports = withBundleAnalyzer({
  ...
  images: {
    domains: ['img.overclockers.co.uk'],
    remotePatterns: [
      {
        protocol: 'https',
        hostname: 'img.overclockers.co.uk',
